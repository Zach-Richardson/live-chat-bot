  ...
  <div class="navbar">
    <div class="ui inverted menu" style>
      <div class="ui container">
        <img
          class="logo"
          src="/images/forsta-logo-invert.svg"
          height="35px"
          width="35px"
          style="margin:5px 5px 5px 0px;vertical-align:bottom"
        >
        <img
          src="/images/logo_just_text.svg"
          height="17px"
          width="119px"
          style="margin:15px 5px 5px 5px;vertical-align:bottom"
        >
        <span style="margin:14px 5px 5px 10px;font-size:1.5em;color:white">Live Chat</span>
        <div class="header item float right" style="padding:0px" v-if="global.apiToken">
          <div class="ui simple dropdown item" style="padding:3px;">
            ...
            <div class="menu left">
              ...
              <div class="item" @click="showingSignOutModal=true">Sign Out</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <sui-modal v-model="showingSignOutModal" size="tiny">
        ...
        <sui-modal-actions style="margin-bottom:20px;padding:10px">
          <sui-button
            ...
            content="Cancel"
          />
          <sui-button floated="right" class="green" @click="logout()" content="Sign Out"/>
        </sui-modal-actions>
      </sui-modal>
    </div>
  </div>
